...
public class SimpleItemTouchHelperCallback extends ItemTouchHelper.Callback {
    ...
    public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        final int swipeFlags = ItemTouchHelper.UP;
...
//            ((RecyclerListAdapter.ItemViewHolder)viewHolder).handleView.setAlpha(alpha);
//            ((RecyclerListAdapter.ItemViewHolder)viewHolder).handleView.setTranslationY(dY);
        } else {
